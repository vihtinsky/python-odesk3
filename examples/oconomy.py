...
def oconomy(public_key, secret_key):
    ...
    print(client.nonauth_oconomy.get_hours_worked_by_locations())
    print(client.nonauth_oconomy.get_hours_worked_by_weeks())
    print("top countries by hours")
    print(client.nonauth_oconomy.get_top_countries_by_hours())
    print(client.nonauth_oconomy.get_most_requested_skills())

    print("monthly summary")
    print(client.nonauth_oconomy.get_monthly_summary('201011'))
    print("hours worked by locations")
    print(client.nonauth_oconomy.get_hours_worked_by_locations())
    print("earnings by categories")
    print(client.nonauth_oconomy.get_earnings_by_categories())
